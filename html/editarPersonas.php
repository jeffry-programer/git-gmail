...
<body>
	...
	<h1 class="display-4 p-3">Editar a <?php echo $key['nombre'] ?></h1>
	<?php endforeach ?>
	<!DOCTYPE html>
<html>
<head>
...
<?php   
	function modificar($nombre,$apellido,$correo,$genero,$pais,$tipoPersona,$contrasena,$idUser,$conexion)
	{

		$modificarPais = "UPDATE personas SET nombre = '$nombre', apellido = '$apellido', correo = '$correo', genero = '$genero', pais = '$pais',  tipoPersona = '$tipoPersona', contrasena = '$contrasena' WHERE idPersonas = '$idUser'";
	...
	if (isset($_POST['registrar'])) 
	{
		...
		if ($tipoPersona == 'administrador') 
		{
			...
			(async()=>{
				...
				{
							<?php 
								modificar($nombre,$apellido,$correo,$genero,$pais,$tipoPersona,$contrasena,$idUser,$conexion);
							?>
				}else
				{
