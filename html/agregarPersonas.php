...
<header><h1 class="display-4 p-3">Agregar Persona</h1></header>
<body class="body">
...
<a href="http://localhost/examen/administracion.php"><button class="btn btn-success p-1 m-3 mt-0 ms-4">Volver a Administración</button></a>

<script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script>
<script src="examen.js"></script>
</body>
<?php   
	function agregarPersona($nombre,$apellido,$correo,$genero,$pais,$contrasena, $tipoPersona,$conexion)
	{
			...
			(async()=>{
				...
				{	
				    ...
				    <?php
							...
							{
								agregarPersona($nombre,$apellido,$correo,$genero,$pais,$contrasena,$tipoPersona,$conexion);
							}
					?>
